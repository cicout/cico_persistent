#
#  Be sure to run `pod spec lint CICOPersistent.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/cicout/cico_persistent.git", :tag => "#{spec.version}" }
  ...
  # spec.resources = "sourcery/templates/*.{stencil, swifttemplate}"
